...
## Testing akasha Interactive Mode with tmux

To test akasha's TUI in a controlled terminal environment:
...
# Send input
tmux send-keys -t akasha-test "your prompt here" Enter

# Send special keys
tmux send-keys -t akasha-test Escape
tmux send-keys -t akasha-test C-o  # ctrl+o

# Cleanup
tmux kill-session -t akasha-test
```
...
- **Internal changes (from issues)**: `Fixed foo bar ([#123](https://github.com/7enChan/akasha/issues/123))`
- **External contributions**: `Added feature X ([#456](https://github.com/7enChan/akasha/pull/456) by [@username](https://github.com/username))`
