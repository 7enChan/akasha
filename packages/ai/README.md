...
```bash
npm install @earendil-works/akasha-ai
```

TypeBox exports are re-exported from `@earendil-works/akasha-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@earendil-works/akasha-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@earendil-works/akasha-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@earendil-works/akasha-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@earendil-works/akasha-ai';
...
```typescript
import { getImageModel, generateImages } from '@earendil-works/akasha-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@earendil-works/akasha-ai';
...
```typescript
import { getModel, stream } from '@earendil-works/akasha-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@earendil-works/akasha-ai';
...
```typescript
import { Model, stream } from '@earendil-works/akasha-ai';
...
Use model-level `thinkingLevelMap` to describe model-specific thinking controls. Keys are akasha thinking levels (`off`, `minimal`, `low`, `medium`, `high`, `xhigh`). Missing keys use provider defaults, string values are sent to the provider, and `null` marks a level unsupported.
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@earendil-works/akasha-ai';
...
```typescript
import { getModel, complete, Context } from '@earendil-works/akasha-ai';
...
```typescript
import { Context, getModel, complete } from '@earendil-works/akasha-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@earendil-works/akasha-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from '@earendil-works/akasha-ai';
...
```bash
npx @earendil-works/akasha-ai login              # interactive provider selection
npx @earendil-works/akasha-ai login anthropic    # login to specific provider
npx @earendil-works/akasha-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@earendil-works/akasha-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from '@earendil-works/akasha-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from '@earendil-works/akasha-ai/oauth';
...
```typescript
import { getModel, complete } from '@earendil-works/akasha-ai';
import { getOAuthApiKey } from '@earendil-works/akasha-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@earendil-works/akasha-ai`
