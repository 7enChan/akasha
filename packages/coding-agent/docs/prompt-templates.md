> akasha can create prompt templates. Ask it to build one for your workflow.
...
Akasha loads prompt templates from:

- Global: `~/.akasha/agent/prompts/*.md`
- Project: `.akasha/prompts/*.md`
- Packages: `prompts/` directories or `akasha.prompts` entries in `package.json`
