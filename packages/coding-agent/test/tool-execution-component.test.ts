...
import { Text, type TUI } from "@earendil-works/akasha-tui";
...
describe("ToolExecutionComponent parity", () => {
	...
	for (const scenario of [
		...
		{
			title: "AGENTS.md",
			path: join(process.cwd(), ".akasha", "AGENTS.md"),
			content: "Hidden resource instructions",
			compact: "read resource .akasha/AGENTS.md",
	...
	for (const scenario of [
		...
		{ title: "Akasha documentation", path: getReadmePath(), compact: "read docs README.md:120-329" },
	] as const) {
