...
import { type AutocompleteProvider, CombinedAutocompleteProvider, Container } from "@earendil-works/akasha-tui";
...
describe("InteractiveMode.showLoadedResources", () => {
	...
	function createExtensionFixtures(): ExtensionFixture[] {
		return [
			{
				path: "/tmp/project/.akasha/extensions/answer.ts",
				sourceInfo: createSourceInfo("/tmp/project/.akasha/extensions/answer.ts", {
					source: "local",
					scope: "project",
					origin: "top-level",
					baseDir: "/tmp/project/.akasha/extensions",
				}),
			},
			{
				path: "/tmp/project/.akasha/extensions/local-index/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.akasha/extensions/local-index/index.ts", {
					source: "local",
					scope: "project",
					origin: "top-level",
					baseDir: "/tmp/project/.akasha/extensions",
			...
			{
				path: "/tmp/project/.akasha/npm/node_modules/akasha-markdown-preview/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.akasha/npm/node_modules/akasha-markdown-preview/extensions/index.ts",
					{
						source: "npm:akasha-markdown-preview",
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.akasha/npm/node_modules/akasha-markdown-preview",
					},
				),
			},
			{
				path: "/tmp/project/.akasha/npm/node_modules/@scope/akasha-scoped/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.akasha/npm/node_modules/@scope/akasha-scoped/extensions/index.ts",
					{
						source: "npm:@scope/akasha-scoped",
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.akasha/npm/node_modules/@scope/akasha-scoped",
					},
				),
			},
			{
				path: "/tmp/project/.akasha/git/github.com/HazAT/akasha-interactive-subagents/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.akasha/git/github.com/HazAT/akasha-interactive-subagents/extensions/index.ts",
					{
						source: "git:github.com/HazAT/akasha-interactive-subagents",
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.akasha/git/github.com/HazAT/akasha-interactive-subagents",
					},
				),
			},
			{
				path: "/tmp/project/.akasha/git/github.com/HazAT/akasha-interactive-subagents/extensions/subagents/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.akasha/git/github.com/HazAT/akasha-interactive-subagents/extensions/subagents/index.ts",
					{
						source: "git:github.com/HazAT/akasha-interactive-subagents",
						scope: "project",
						origin: "package",
...
"[Extensions]
  @scope/akasha-scoped, akasha-markdown-preview, answer.ts, cli-extension.ts, HazAT/akasha-interactive-subagents, HazAT/akasha-interactive-subagents:subagents, local-index, user-index"`);
	});
...
"[Extensions]
  project
    /tmp/project/.akasha/extensions/answer.ts
    /tmp/project/.akasha/extensions/local-index
    git:github.com/HazAT/akasha-interactive-subagents
      extensions
      extensions/subagents
    npm:@scope/akasha-scoped
      extensions
    npm:akasha-markdown-preview
      extensions
  user
  ...
  path
	...
	test("shows context paths relative to cwd while preserving full external paths", () => {
		const home = homedir();
		const cwd = path.join(home, "Development", "akasha");
		const fakeThis = createShowLoadedResourcesThis({
			quietStartup: false,
			cwd,
			contextFiles: [
				{ path: path.join(home, ".akasha", "agent", "AGENTS.md") },
		...
		expect(output).toContain("~/.akasha/agent/AGENTS.md, AGENTS.md");
	...
	test("shows full context paths when expanded", () => {
		...
		const output = renderAll(fakeThis.chatContainer).replace(/\\/g, "/");
		expect(output).toContain("[Context]");
		expect(output).toContain("~/.akasha/agent/AGENTS.md");
		expect(output).toContain("~/Development/akasha/AGENTS.md");
		expect(output).not.toContain("~/.akasha/agent/AGENTS.md, AGENTS.md");
	});
