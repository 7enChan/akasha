    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="akasha-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="akasha-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'akasha-share:v1:sidebar-width';
