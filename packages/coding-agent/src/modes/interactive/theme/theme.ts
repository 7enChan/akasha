...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@earendil-works/akasha-tui";
...
const THEME_KEY = Symbol.for("@earendil-works/akasha-coding-agent:theme");
const THEME_KEY_OLD = Symbol.for("@earendil-works/akasha-coding-agent:theme");
...
export function getSettingsListTheme(): import("@earendil-works/akasha-tui").SettingsListTheme {
	return {
