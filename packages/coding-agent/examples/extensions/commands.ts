 ...
 * Commands Extension
 *
 * Demonstrates the akasha.getCommands() API by providing a /commands command
...
import type { ExtensionAPI, SlashCommandInfo } from "@earendil-works/akasha-coding-agent";

export default function commandsExtension(akasha: ExtensionAPI) {
	akasha.registerCommand("commands", {
