 ...
 *   akasha -e ./packages/coding-agent/examples/extensions/custom-provider
 *
 *   # With API key
 *   CUSTOM_ANTHROPIC_API_KEY=sk-ant-... akasha -e ./packages/coding-agent/examples/extensions/custom-provider
 *
...
export default function (akasha: ExtensionAPI) {
	akasha.registerProvider("custom-anthropic", {
