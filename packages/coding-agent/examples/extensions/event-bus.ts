 ...
 *
 * Shows akasha.events for communication between extensions. One extension
...
export default function (akasha: ExtensionAPI) {
	...
	akasha.events.on("my:notification", (data) => {
