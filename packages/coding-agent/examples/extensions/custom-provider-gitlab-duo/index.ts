 ...
 * Delegates to akasha-ai's built-in Anthropic and OpenAI streaming implementations.
 *
 * Usage:
 *   akasha -e ./packages/coding-agent/examples/extensions/custom-provider-gitlab-duo
...
export default function (akasha: ExtensionAPI) {
	akasha.registerProvider("gitlab-duo", {
