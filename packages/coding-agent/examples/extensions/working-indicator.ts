 ...
 * working indicator shown while akasha is streaming a response.
 *
 * Usage:
 *   akasha --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore akasha's default spinner
 */

import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "@earendil-works/akasha-coding-agent";
...
export default function (akasha: ExtensionAPI) {
	...
	akasha.registerCommand("working-indicator", {
