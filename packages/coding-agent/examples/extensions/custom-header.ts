 ...
 * (logo + keybinding hints) with a custom component showing the akasha mascot.
 */

import type { ExtensionAPI, Theme } from "@earendil-works/akasha-coding-agent";
import { VERSION } from "@earendil-works/akasha-coding-agent";

// --- PI MASCOT ---
// Based on pi_mascot.ts - the akasha agent character
...
export default function (akasha: ExtensionAPI) {
	...
	akasha.registerCommand("builtin-header", {
