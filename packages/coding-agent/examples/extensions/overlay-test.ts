 ...
 *
 * Usage: akasha --extension ./examples/extensions/overlay-test.ts
 *
...
import { CURSOR_MARKER, type Focusable, matchesKey, visibleWidth } from "@earendil-works/akasha-tui";

export default function (akasha: ExtensionAPI) {
	akasha.registerCommand("overlay-test", {
