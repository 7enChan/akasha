 ...
 * - Routing tool calls to remote systems (e.g., akasha-ssh-remote)
...
import type { TextContent } from "@earendil-works/akasha-ai";
import { type ExtensionAPI, getAgentDir, withFileMutationQueue } from "@earendil-works/akasha-coding-agent";
...
export default function (akasha: ExtensionAPI) {
	...
	akasha.registerCommand("read-log", {
