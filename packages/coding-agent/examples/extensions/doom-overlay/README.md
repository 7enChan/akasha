...
Play DOOM as an overlay in akasha. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
akasha --extension ./examples/extensions/doom-overlay
```
...
- [akasha-doom](https://github.com/badlogic/akasha-doom) for the original akasha integration
