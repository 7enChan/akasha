#!/usr/bin/env bash
# Build DOOM for akasha-doom using doomgeneric and Emscripten
...
cp "$DOOM_DIR/doomgeneric_akasha.c" "$DOOM_DIR/doomgeneric/doomgeneric/"
