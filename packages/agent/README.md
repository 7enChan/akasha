# @earendil-works/akasha-agent-core

Stateful agent with tool execution and event streaming. Built on `@earendil-works/akasha-ai`.

## Installation

```bash
npm install @earendil-works/akasha-agent-core
```
...
```typescript
import { Agent, streamProxy } from "@earendil-works/akasha-agent-core";
...
```typescript
import { agentLoop, agentLoopContinue } from "@earendil-works/akasha-agent-core";
