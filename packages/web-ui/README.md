# @earendil-works/akasha-web-ui

Reusable web UI components for building AI chat interfaces powered by [@earendil-works/akasha-ai](../ai) and [@earendil-works/akasha-agent-core](../agent).
...
```bash
npm install @earendil-works/akasha-web-ui @earendil-works/akasha-agent-core @earendil-works/akasha-ai
```
...
```typescript
import { Agent } from '@earendil-works/akasha-agent-core';
...
import {
  ...
  defaultConvertToLlm,
  ApiKeyPromptDialog,
} from '@earendil-works/akasha-web-ui';
import '@earendil-works/akasha-web-ui/app.css';
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@earendil-works/akasha-web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@earendil-works/akasha-web-ui';
...
```typescript
import { createExtractDocumentTool } from '@earendil-works/akasha-web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@earendil-works/akasha-web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@earendil-works/akasha-web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@earendil-works/akasha-web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@earendil-works/akasha-web-ui';
...
```typescript
import { SessionListDialog } from '@earendil-works/akasha-web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@earendil-works/akasha-web-ui';
...
```typescript
import { ModelSelector } from '@earendil-works/akasha-web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@earendil-works/akasha-web-ui';
...
- [sitegeist](https://sitegeist.ai) - Browser extension using akasha-web-ui
