# Akasha Web UI - Example

This is a minimal example showing how to use `@earendil-works/akasha-web-ui` in a web application.
...
- [Akasha Web UI Documentation](../README.md)
- [Akasha AI Documentation](../../ai/README.md)
