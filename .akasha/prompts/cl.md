...
Attribution:
- Internal: `Fixed foo ([#123](https://github.com/7enChan/akasha/issues/123))`
- External: `Added bar ([#456](https://github.com/7enChan/akasha/pull/456) by [@user](https://github.com/user))`
